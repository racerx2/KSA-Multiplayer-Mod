...
namespace KSA.Mods.Multiplayer
{
    public class ChatManager
    {
        ...
        /// <summary>
        /// Send a system message (shown to all players)
        /// </summary>
        public void SendSystemMessage(string text)
        {
            var message = new ChatMessage("System", text, DateTime.UtcNow, ChatMessageType.System);
            AddMessageToHistory(message);
            OnMessageReceived?.Invoke("System", text);
            
            // TODO: Send via network to other players
        }
        
        /// <summary>
        /// Add a local system message (not sent to others)
        /// </summary>
